...
$pagination = new Pagination($current_page, 2, 'pages', $page_args);
$args = array(
  'table' => 'pages',
...
<div class="col-md-3 order-md-2">
  ...
  <div class="form-group d-flex justify-content-between align-items-center">
    ...
    <a href="single-page.php"><button class="btn btn-primary"><i class="fas fa-plus"></i></button></a>
  </div>
</div>
    ...
    <tbody>
      <?php foreach($posts->get_posts() as $post): ?>
        <tr>
          ...
          <td><a href="single-page.php?id=<?php echo $post['id']?>"><?php echo $post['title'] ?></a></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h6>You are deleing page with:</h6>
        <ul>
          <li id="li_id">Id:</li>
